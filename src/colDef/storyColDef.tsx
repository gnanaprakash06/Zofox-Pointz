...
export const createStoryColumns = (
  onActionClick: (payload: StoryActionType) => void
) => [
  ...
  columnHelper.accessor("listensCount", {
    header: "Listens",
    cell: (info) => (
